...
def define_room_classes(RoomBase):
  class MasterRoom(RoomBase):
    ...
    def get_entity_declarations(self):
      ...
      self.add_device('cddz_cn_blt_3_1q11go7f90k00_cdwx8_customized_event_5_e_2_1097', self.room_name + ' 8-Key Remote',     'Button',         'Jiuhao 8-Key Remote')
  ...
  class GuestRoom(RoomBase):
    ...
    def get_entity_declarations(self):
      ...
      self.add_device("50ec50dd67be_light",               self.room_name + " Lamp 1",        'Light',              "Generic Light")
      self.add_device("hue_ambiance_lamp_3",              self.room_name + " Lamp 2",        'Light',              "Generic Light")
      self.add_device("50ec50ded70f_light",               self.room_name + " Lamp 3",        'Light',              "Generic Light")
      ...
      self.add_device('cddz_cn_blt_3_1q1b7e7k4cc00_cdwx8_customized_event_5_e_2_1097', self.room_name + ' 8-Key Remote',     'Button',         'Jiuhao 8-Key Remote')
    ...
    def get_light_entities(self):
      super().get_light_entities()
      # Light/Switch entities
      self.leds                    = ["switch.guest_room_desk_screen_led"]
      self.lamps                   = ["light.guest_room_lamp_1",
                                      "light.guest_room_lamp_2",
                                      "light.guest_room_lamp_3",
                                     ]
      self.add_group('light', 'Guest Room Lamp', self.lamps)
      self.lights                  = self.leds + self.lamps + self.ceiling_lights
  ...
  class Study(RoomBase):
    ...
    def get_entity_declarations(self):
      ...
      self.add_device('de1_cn_blt_3_1q0ubuebd0802_wjwx8_customized_event_5_e_2_1097', self.room_name + ' 8-Key Remote', 'Button', 'DEBROGLIE 8-Key Remote')
      ...
      self.add_device("50ec50df0a79_light",         self.room_name + ' Lamp 1',         'Light',              "Generic Light")
      self.add_device("e14w_1_tuya",                self.room_name + ' Lamp 2',         'Light',              "Generic Light")
      self.add_device("e14w_2_tuya",                self.room_name + ' Lamp 3',         'Light',              "Generic Light")
