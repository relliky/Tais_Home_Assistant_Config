...
1. Move dashboard generation into its own module.
2. Move room-specific classes into a `rooms.py` module.
3. Split `RoomBase` only after the generated-output tests are strong.
